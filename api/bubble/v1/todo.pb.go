...
func (x *UpdateTodoReply) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *UpdateTodoReply) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *UpdateTodoReply) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
const file_api_bubble_v1_todo_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x16\n" +
	"\x06status\x18\x03 \x01(\bR\x06status\"O\n" +
	"\x0fUpdateTodoReply\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x16\n" +
	"\x06status\x18\x03 \x01(\bR\x06status\"#\n" +
